...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="resources/css/login/signup_agree.css" />
</head>
	<body>
	    <div class="container">
            ...
            <div class="main-content">
                <div class="main-title">
                    ...
                    <div class="main-title-text2"> 
                        <p>01 약관동의 > <span class="main-title-span">02 정보입력</span> > <span class="main-title-span">03 가입완료</span></p>
                    </div>
                </div>
                <div class="main-agree">
                    <div class="main-agree-title">
                        <p>약관동의</p>
                    </div>
                    <div class="main-agree-text">
                        <div class="agree-text-check1">
                            <input type="checkbox" id="check1" name="check"><label for="check1"><span class="check-span1">릴렉스빈의 모든 약관을 확인하고 전체 동의합니다. </span>(전체동의, 선택항목도 포함됩니다.)</label><br>
                        </div>
                        <div class="agree-text-check2">
                            <input type="checkbox" id="check2" name="check"><label for="check2"><span class="check-span2">(필수)</span>이용약관<a href="">전체보기></a></label>
                        </div>
                    </div>
                    <div class="main-agree-tou1">
                        <p>
                            제1조(목적)

                            표준약관 제10023호

                            이 약관은 주식회사 에이블커피그룹 회사(전자거래 사업자)가 운영하는 빈브라더스 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
                            ※ 「PC통신등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는한 이 약관을 준용합니다」


                            제2조(정의)

                            ① "몰"이란 주식회사 에이블커피그룹 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
                            ...
                            제26조(구독 서비스 이용 자격) 
                            “몰” 회원이면 누구나 “구독 서비스”을 신청하고 가입을 완료함으로써 이용이 가능합니다.
                            

                            제27조(구독 서비스 및 정기구매 이용, 결제, 반품/교환, 혜택 변경, 해지 등) 
                            ① 회사는 구독 서비스에 가입한 고객에 한하여, 상품에 대하여 할인 혜택을 제공할 수 있으며, 할인율 및 거래조건 등은 서비스 및 상품 별로 다를 수 있고, 언제든 변경될 수 있습니다. 할인율 및 거래조건 등이 이용자에게 불리하게 변경되는 경우 회사는 2주 이상의 상당한 기간 동안 위 변경에 대하여 공지하고, 고객은 위 변경에 동의하지 않으면 위 기간 동안 본 “구독 서비스”를 해지하거나 “정기구매 상품 및 서비스”를 종료시킬 수 있으며, 위 기간 동안 “구독 서비스”를 종료시키지 않으면 위 변경에 고객이 동의한 것으로 봅니다.
                            ② 제공하는 서비스의 특성상 배송 이후 반품/교환을 할 수 없습니다. “몰”은 결제 대금의 환불이 발생하는 경우 거래가 취소된 날로부터 2 영업일 이내에 이용자에게 환불에 필요한 조치를 합니다. 카드 결제를 통한 서비스 이용건의 환불은 카드결제 취소를 통해서만 가능합니다. 회원은 결제 후 7일 이내, 상품이 발송되기 전까지 서비스 이용을 취소할 수 있습니다.
                            ② 구독 서비스의 특성상 상품의 가격은 계속적으로 변경될 수 있으며, 고객에게 고지된 시점의 상품 가격을 기준으로 결제가 이루어집니다. 가격 결정의 기준 시점은 변경될 수 있습니다.
                            ③ 구독 서비스의 특성상 가입 및 이용시 고객에게 제공되는 혜택의 종류, 내용, 크기,제공 기간은 계속적으로 변경될 수 있으며, 고객에게 고지된 시점을 기준으로 혜택이 적용됩니다.  
                            ④ 구독 서비스의 상품의 추가 또는 변경 시 결제되는 총 상품의 금액은 변경됩니다.  
                            ⑤ 카드 한도 초과 등으로 상품의 결제가 이루어 지지 않을 경우, 해당 회차의 정기구매 주문은 이루어지지 않을 수 있으며, 위와 같은 상황이 2회 이상 지속되는 경우 회사는 정기구매 상품 등을 중지할 수 있습니다. 
                            ...
                            제29조(회원의 구독 서비스 해지) 
                            회원은 회사에게 통지하거나, 몰의 마이페이지에서 해지 신청함으로써 종료시킬 수 있습니다. 회원이 마이페이지 등 홈페이지에서 로그인 후 해지 신청을 하는 것이 아닌 전화, 카카오톡 등 회원을 식별하기가 어려운 방법으로 회사에 통지하는 경우, 회사가 회원의 통지를 확인할 수 있는 이름, 전화번호, 이메일 등의 정보를 알려주어야 하며, 통지시 위의 정보를 전달하지 않음으로 인해 회원에게 발생한 피해에 대해서는 보상할 책임을 가지지 않습니다. 
                            

                            제30조(구독 서비스 이용의 제한) 
                            
                            ① 고객의 통지 또는 과실에 의해서 구독 서비스 클럽 및 정기구매 서비스가 중지되는 경우(일부 상품에 대하여 정기구매 서비스가 중지되는 경우를 포함합니다.) 해당 상품의 정기구매 서비스 신청이 2개월의 범위 내에서 제한될 수 있습니다. 
                            ② 회사는 특정상품에 대하여 구매 수량을 제한할 수 있습니다. 
                            ③ 회사는 상품의 재판매 가능성이 있는 경우, 또는 불법적이거나 부당한 행위와 관련된 경우 회원의 구독 서비스 및 정기구매 이용을 제한할 수 있습니다. 
                            ④ 회사는 더 많은 회원들에게 혜택을 제공하기 위하여, 일부 혜택의 경우 가입하는 소비자 1명에게 1회에 한하여 한정적으로 제공됩니다. 혜택을 남용하기 위하여, 복수의 아이디로 가입하는 행위, 해지와 재가입을 반복하는 행위 등을 하는 경우에는 이용을 제한할 수 있습니다. 
                            ⑤ 서비스 이용의 제한에 대한 구체적인 기준은 내부 운영정책에 따라 적용됩니다. 
                            ⑥ 회사는 자체적인 시스템을 통한 모니터링과 각종 기관에서 접수된 민원 내용, 수사기관의 정보 등을 통해 정황을 확인한 후, 정기구매 서비스 제한 사유 행위를 한 것으로 추정되는 경우 정기구매 서비스 이용을 제한할 수 있습니다. 
                    ...
                    <div class="main-agree-check">
                        <input type="checkbox" id="check3" name="check"><label for="check3"><span class="check-span3">(필수)</span>개인정보 수집 및 이용<a href="">전체보기></a></label>
                    </div>
                    <div class="main-agree-tou2">
                        <p>
                ...
                <div class="prev-next">
                    <div class="prev">
                        <button id="btn_agree_prev">이전단계</button>
                    </div>
                    <div class="next">
                        <button id="btn_agree_next">다음단계</button>
                    </div>
                </div>
            </div>
        </section>
...
<script src="resources/js/login/signup_agree.js" type="text/javascript"></script>
