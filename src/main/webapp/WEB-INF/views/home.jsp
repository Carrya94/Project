...
<body>
	<div class="container">
		<jsp:include page="/WEB-INF/views/common/header4.jsp"/>
...
<script src="resources/js/home/home.js" type="text/javascript"></script>
<script src="resources/js/common/footer.js" type="text/javascript"></script>
<script src="resources/js/common/header4.js" type="text/javascript"></script>